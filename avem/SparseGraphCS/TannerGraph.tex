...
\path(bitnD\cn)++(0.6*\moveX,-0.3*\moveX) node(){\tiny{$\mathbf{S}$}};
}

\node [right=0.3*\nodewidth of checknC2]{\tiny{$P$ generator nodes}};
\onslide<3->
\node [below=5*\nodewidth of bitnD2,anchor=west]{\footnotesize{$M=M_1 \times P$ } \tiny{generator nodes}};
